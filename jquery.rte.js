 ...
 * Version: 1.3
 * Author: Neeraj Kumar
 * URL: http://www.github.com/neerajkumar
 * Modified in 2011
 */
...
var lwRTE = function (textarea, options) {
	...
	this.iframe_body_css = options.iframe_body_css;
...
lwRTE.prototype.enable_design_mode = function() {
	...
	var doc = "<html><head></head><body style='" + self.iframe_body_css + "'>" + content + "</body></html>";
